...
def home(request):
    ...
    if request.method == 'POST':
        ...
        while price_check() >= temp_price:
            ...
            messages.success(request, {'Tracker Used. If The Price Drops, We Will Email You!'})
            time.sleep(3600)
            price_check()
        ...
        return render(request, "home.html", messages.success(request, 'Tracker Used. If The Price Drops, We Will Email You!'))
    else:
